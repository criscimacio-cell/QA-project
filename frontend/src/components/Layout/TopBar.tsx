  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSearch} className="flex-1 max-w-[480px]">
        <div
          className={`relative flex items-center rounded-xl transition-all duration-300 ${
            searchFocused
              ? 'shadow-[0_0_0_2px_rgba(6,95,70,0.35)]'
              : ''
          }`}
          style={{
        ...
        >
          <Search
            ...
            className={`absolute left-3.5 transition-colors duration-200 ${
              searchFocused ? 'text-[#065F46]' : 'text-slate-500'
            }`}
          />
          <input
            value={query}
      ...
      <div className="flex items-center gap-1 ml-auto">
        ...
        <button
          onClick={toggle}
          className="relative w-9 h-9 flex items-center justify-center rounded-xl text-slate-500 dark:text-slate-400 hover:text-[#065F46] dark:hover:text-[#A7F3D0] transition-all duration-200 bg-slate-100 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700/50"
        ...
        <div className="relative" ref={notifRef}>
          <button
            ...
            title="Notifications"
          >
            <Bell size={17} className={notifCount > 0 ? 'text-[#065F46]' : ''} />
            {notifCount > 0 && (
              <>
          ...
          {showNotif && (
            ...
            >
              ...
              <div
                ...
                style={{
                  background: 'linear-gradient(135deg, rgba(6,95,70,0.07), rgba(167,243,208,0.04))',
                }}
              >
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <div
                        ...
                        style={{
                          background: !n.read
                            ? 'linear-gradient(135deg, rgba(6,95,70,0.15), rgba(167,243,208,0.1))'
                      ...
                      {!n.read && (
                        <div
                          ...
                          style={{ background: '#065F46', boxShadow: '0 0 6px rgba(6,95,70,0.5)' }}
                        />
                      )}
                    </div>
                  </div>
        ...
        <div className="relative" ref={userRef}>
          <button
            className="flex items-center gap-2.5 pl-1 pr-2 py-1 rounded-xl transition-all duration-200 bg-slate-100 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700/50 hover:border-[#065F46]/50"
          ...
          >
            <div className="relative flex-shrink-0">
              <img
                ...
                style={{ border: '2px solid rgba(6,95,70,0.4)' }}
              />
            ...
            <div className="text-left hidden sm:block">
              ...
              <div className="text-xs capitalize leading-none mt-0.5 font-medium" style={{ color: '#065F46' }}>
                {user?.role}
              </div>
            </div>
            <ChevronDown
            ...
            >
                ...
                <div className="flex items-center gap-3">
                  <div className="relative flex-shrink-0">
                    <img
                      ...
                      style={{ border: '2px solid rgba(6,95,70,0.35)' }}
                    />
              ...
              <div className="py-1">
                <button onClick={() => { setShowUser(false); navigate('/settings'); }} className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800/60 transition-colors">
                  ...
                  >
                    <User size={13} style={{ color: '#065F46' }} />
                  </div>
