    ...
    <div className="space-y-5 animate-fade-in-up">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-100 dark:bg-slate-800">
          <ArchiveIcon size={15} className="text-slate-500 dark:text-slate-400" />
      ...
      <div className="card p-4 flex items-center gap-3">
        ...
        <span className="ml-auto text-xs text-slate-500 dark:text-slate-400">{total} result{total !== 1 ? 's' : ''}</span>
      </div>
        ...
        {loading ? (
          ...
          {selectedIds.size > 0 && (
            <div className="flex items-center gap-3 px-4 py-2 bg-amber-50 dark:bg-amber-900/20 border-b border-amber-100 dark:border-amber-800">
              ...
              <button onClick={() => setSelectedIds(new Set())} className="ml-auto text-xs text-slate-500 dark:text-slate-400 hover:text-slate-600">Clear</button>
            </div>
          )}
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-2 max-w-[220px]">
                        ...
                        <div className="min-w-0">
                          ...
                          <div className="text-xs text-slate-500 dark:text-slate-400 truncate" title={f.original_name}>{f.original_name}</div>
                        </div>
                      </div>
                    </td>
