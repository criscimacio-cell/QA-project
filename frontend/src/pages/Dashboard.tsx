...
export default function Dashboard() {
  ...
  const orgPlan = (user as any)?.org_plan;
  const orgName = (user as any)?.org_name;
        ...
        <div className="flex items-center justify-between rounded-xl px-4 py-2.5 text-sm"
          ...
          {orgPlan && (
            <span className={`px-2.5 py-0.5 rounded-full text-xs font-semibold capitalize ${
              orgPlan === 'enterprise' ? 'bg-violet-100 text-violet-700 dark:bg-violet-900/30 dark:text-violet-300' :
              orgPlan === 'pro'        ? 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300' :
