...
export default function CTA() {
  ...
  return (
    <section ref={ref} className="py-24 relative overflow-hidden bg-white">
      ...
      {/* Animated rings — scale with scroll */}
      ...
      <div className="relative max-w-3xl mx-auto px-6 text-center">
        ...
        >
          <motion.div variants={blurUp}
            className="inline-flex items-center gap-2 bg-amber-50 border border-amber-200 rounded-full px-4 py-1.5 text-xs font-medium text-amber-700">
