...
const PLANS = [
  {
    name: 'Free', price: '$0', period: 'forever', desc: 'Perfect for small QA teams getting started.',
    cta: 'Get Started', ctaHref: '/register', highlight: false,
    features: ['Up to 5 users', '2 repositories', '1 GB storage', 'File manager & versioning', 'Basic approval workflow', 'Knowledge base (read-only)'],
  },
  {
    name: 'Pro', price: '$29', period: 'per month', desc: 'For growing QA teams that need more power.',
    cta: 'Start Pro Trial', ctaHref: '/register?plan=pro', highlight: true, badge: 'Most Popular',
    features: ['Unlimited users', 'Unlimited repositories', '50 GB storage', 'Full approval workflows', 'Knowledge base (full access)', 'Test data library', 'Custom roles & RBAC', 'Audit log & CSV export', 'Email notifications', 'Priority support'],
  },
  {
    name: 'Enterprise', price: 'Custom', period: 'contact us', desc: 'For large orgs with security and compliance needs.',
    cta: 'Contact Sales', ctaHref: 'mailto:sales@qlarity.io', highlight: false,
    features: ['Everything in Pro', 'Unlimited storage', 'SSO / SAML', 'Dedicated infrastructure', 'SLA guarantee', 'Custom integrations', 'Onboarding support', 'Security review'],
  },
];
      ...
      <div className="relative max-w-6xl mx-auto px-6">
        ...
        >
          <motion.div variants={blurUp}
            className="inline-flex items-center gap-2 bg-violet-50 border border-violet-200 rounded-full px-4 py-1.5 text-xs font-medium text-violet-700 mb-4">
